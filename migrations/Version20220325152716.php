 ...
 */
final class Version20220325152716 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP INDEX UNIQ_42C849554FFCB518, ADD INDEX IDX_42C849554FFCB518 (suite_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP INDEX IDX_42C849554FFCB518, ADD UNIQUE INDEX UNIQ_42C849554FFCB518 (suite_id)');
